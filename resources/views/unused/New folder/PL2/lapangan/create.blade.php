...
@section('content')
    @form(['method' => 'POST', 'route' =>route('lapangan.store'), 'fileupload' => 'yes'])
        ...
        @slot('body')
            ...
            <div class="form-gp @if(old('no_telepon')) focused @endif">
            ...
            <div class="table-responsive">
                <table class="table borderless">
                    ...
                    <tr>
                        ...
                        <td class="py-0 px-0">
                            <div class="custom-control custom-checkbox custom-control-inline">
                                <input type="checkbox" checked="" class="custom-control-input" id="minggu" name="hari_buka[]" value="7">
            ...
            <div class="table-responsive">
                <table class="table borderless">
                    <tr>
                        <td class="px-0 py-0" style="color:#7e74ff">Lapangan's Picture</td>
                    </tr>
                    <tr>
