...
@section('title', 'Add Lapangan to Customer Service')

@section('content')
    @form(['method' => 'POST', 'route' =>route('service.store', ['CS' => $CS])])
        @slot('header', 'Add Lapangan to Customer Service')
            ...
            <div class="submit-btn-area">
				<div class="col-md-12 p-0">
					<div class="row">
						...
						<div class="col-md-6 p-1">
							<a href="{{ route('CS.show', ['CS' => $CS]) }}"><button id="form_submit" type="button">Go Back <i class="ti-back-left"></i></button></a>
						</div>
					</div>
				</div>
			</div>
