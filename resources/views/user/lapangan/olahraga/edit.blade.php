        ...
        @slot('body')
            ...
            <div class="form-group">
                ...
                <select class="form-control form-control-lg" name="jenis_olahraga" required>
                    @foreach(App\LapanganOlahraga::$jenisOlahraga as $jenis_olahraga)
                        <option @if($olahraga->jenis_olahraga == $jenis_olahraga) selected @endif>{{ $jenis_olahraga }}</option>
                    @endforeach
                </select>
            </div>
            <div class="table-responsive">
                <table class="table borderless">
                    <tr>
                        <td class="px-0 py-0" style="color:#7e74ff">Ubah Gambar Lapangan Olahraga</td>
                    </tr>
                    <tr>
